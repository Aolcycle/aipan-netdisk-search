export default defineNuxtConfig({
    ...
    app: {
        ...
        head: {
            ...
            meta: [
                { name: 'keywords', content: '电子榨菜, 免费资源搜索, 网盘搜索, 音乐下载, 网盘资源搜索神器, 夸克网盘, 百度网盘, 阿里云网盘, 资源, 教学工具, 非商业用途' },
                { hid: 'description', name: 'description', content: '电子榨菜网是一个开源免费的资源搜索平台，提供网盘资源搜索、打造丰富的影视音聚合体验，供学习与探索使用，不支持商业用途。' },
